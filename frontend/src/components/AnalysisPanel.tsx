        ...
        <div className="flex flex-col items-center justify-center py-16 gap-5">
          ...
          <div className="text-center max-w-md">
            ...
            <div className="text-text-secondary text-xs mb-4 leading-relaxed">
              Analizele sunt generate zilnic pe baza datelor actualizate — cote, statistici și formă recentă. Pentru predicții cât mai precise, analiza devine disponibilă după sincronizarea zilnică de la ~10:00.
            </div>
